#!/usr/bin/env python3
"""
Multi-Sender Mass Transfer Script
Processes transfers using multiple sender accounts simultaneously for maximum throughput
"""
...
SENDERS = [
    ...
    # {
    #     'private_key': 'YOUR_PRIVATE_KEY_2_HERE',
    #     'name': 'Sender 2'
    # },
    # {
    #     'private_key': 'YOUR_PRIVATE_KEY_3_HERE',
    #     'name': 'Sender 3'
    # },
    # {
    #     'private_key': 'YOUR_PRIVATE_KEY_4_HERE',
    #     'name': 'Sender 4'
    # },
    # {
    #     'private_key': 'YOUR_PRIVATE_KEY_5_HERE',
    #     'name': 'Sender 5'
    # },
]
...
MAX_WORKERS_PER_SENDER = 100  # Concurrent batches per sender
RATE_LIMIT_DELAY = 0.05  # Delay between batches in seconds
MAX_RETRIES = 3
...
def main():
    ...
    for i, sender in enumerate(SENDERS):
        print(f"  {sender['name']}: {len(sender_batches[i])} batches")
    
    print(f"\nStarting multi-sender mass transfer...")
    print(f"Estimated time: ~{(total_batches * RATE_LIMIT_DELAY / len(SENDERS)):.1f} seconds\n")
